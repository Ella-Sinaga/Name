/*
* WOY NAMA GUE INI
* JANGAN DI UBAH YA TOD
* RAMLAN GANS NO DEBAT
* KETAHUAN KU BANNED KAU
* I LOVE YOU :V
*/
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '6285559240360@s.whatsapp.net' // JANGAN DIGANTI TOD NOMOR NYA
       ...
       /******END OF FUNCTIONS INPUT******/
		...
		client.sendMessage(from, bahasa(prefix, sender), text, {quoted: mek})
               ...
               break
                case 'irii':
                case 'iri':
			client.sendPtt(from, './Ramlan/iri.mp3', id)
			break
			case 'abangjago':
			case 'bangjago':
			client.sendPtt(from, './Ramlan/abangjago.mp3', id)
			break
			case 'desah':
			client.sendPtt(from, './Ramlan/desah.mp3', id)
			break
			case 'tarekses':
			case 'tariksis':
			client.sendPtt(from, './Ramlan/tarekses.mp3', id)
			break
			case 'welot':
			case 'copet':
			client.sendPtt(from, './Ramlan/welot.mp3', id)
			break
				case 'demote':
              ...
              await client.sendMessage(from, options, text)
               break
				...
				case 'snowrite':
					...
					var gbl7 = gh.split("&")[0];
					var gbl8 = gh.split("&")[1];
					if (args.length < 1) return reply(`Kirim perintah ${prefix}snowrite teks1&teks2, contoh ${prefix}snowrite Ramlan&Doinya`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
				...
				case 'marvellogo':
					...
					var gbl5 = gh.split("&")[0];
					var gbl6 = gh.split("&")[1];
					if (args.length < 1) return reply(`Kirim perintah ${prefix}marvellogo teks1&teks2, contoh ${prefix}marvellogo Ramlan&Doinya`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
		...
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
				...
				case 'ytmp3':
					...
					break
					case 'ytmp4':
				if (args.length < 1) return reply('link YouTube nya mana um?')
					tels = body.slice(7)				
					reply(mess.wait)
				...
				case 'nulis': 
				case 'tulis':
					if (args.length < 1) return reply('yang mau ditulis apa? *TITID* ?')
                                        if (!isUser) return reply(mess.only.daftarB)
					teks = body.slice(7)
					reply(mess.wait)
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				client.updatePresence(from, Presence.composing) 
					...
					mentions('╔══✪〘 𝐌𝐞𝐧𝐭𝐢𝐨𝐧 𝐀𝐥𝐥 〙✪══\n╠➥'+teks+'╚═〘 𝐒𝐚𝐝𝐁𝐨𝐭𝐳 〙', members_id, true)
					break
                case 'tagall2':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
					...
					client.sendMessage(from, '╔══✪〘 𝐌𝐞𝐧𝐭𝐢𝐨𝐧 𝐀𝐥𝐥 〙✪══\n╠➥'+teks+'╚═〘 𝐒𝐚𝐝𝐁𝐨𝐭𝐳 〙', text, {quoted: mek})
					break
                case 'tagall3':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
					...
					client.sendMessage(from, '╔══✪〘 𝐌𝐞𝐧𝐭𝐢𝐨𝐧 𝐀𝐥𝐥 〙✪══\n╠➥'+teks+'╚═〘 𝐒𝐚𝐝𝐁𝐨𝐭𝐳 〙', text, {detectLinks: false, quoted: mek})
					break
                        case 'tagall4':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
				...
				if (!isQuotedImage) return reply(`Kirim gambar dengan caption ${prefix}setbotpp atau tag gambar yang sudah dikirim`)
					...
					reply('Makasih profil barunya um')
					break
				case 'bc':
					client.updatePresence(from, Presence.composing) 
					if (!isOwner) return reply(mess.only.ownerB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*「 〘 𝐒𝐚𝐝𝐁𝐨𝐭𝐳 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 〙 」*\n\n${body.slice(4)}`})
						}
						reply('')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*「 〘 𝐒𝐚𝐝𝐁𝐨𝐭𝐳 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 〙 」*\n\n${body.slice(4)}`)
						}
				...
				case 'alay':
                    ...
                    client.sendMessage(from, hasil, image, {quoted: mek, caption: 'jadi nihh tod...'})
                    break
                    case 'glitch':
                    gh = body.slice(7)
                    if (!isUser) return reply(mess.only.daftarB)
                    ...
                    hasil = await getBuffer(data.result)
                    client.sendMessage(from, hasil, image, {quoted: mek, caption: 'Kemren bahh...'})
                    break
                     case 'leave':
                    if (!isGroup) return reply(mess.only.group)
                    if (!isGroupAdmins) return reply(mess.only.admin)
					...
					client.groupLeave (from) 
                     ...
                     setTimeout( () => {
					client.updatePresence(from, Presence.composing) 
					client.sendMessage(from, 'Yahh Aku di usir:) byeee👋', text) // ur cods
					}, 0)
                     break
	    ...
	    case 'kapankah':
			...
			case 'tutupgc':
               ...
               if (anu.error) return reply(anu.error)
				...
				if (isUser) return reply(mess.only.daftarB)
					hobby = body.slice(1)
					const hob =['Memasak','Membantu Atok','Mabar','Nobar','Sosmedtan','Membantu Orang lain','Nonton Anime','Nonton Drakor','Naik Motor','Nyanyi','Menari','Bertumbuk','Menggambar','Foto fotoan Ga jelas','Maen Game','Berbicara Sendiri','nonton bokep']
				    ...
				    try{
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'stop comli'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
				    ...
				    try{
						...
						buffer = await getBuffer(res.result)
                                                if (!isUser) return reply(mess.only.daftarB)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nihh tod'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
				...
				case 'logowolf':
					...
					if (args.length < 1) return reply(`teksnya mana? contoh ${prefix}logowolf Ramlan&Gans`)
					reply(mess.wait)
				...
				case 'logowolf2':
					...
					var gbl1 = gh.split("&")[0];
					var gbl2 = gh.split("&")[1];
					if (args.length < 1) return reply('Teksnya mana um\nContoh: ${prefix}pornhub Ramlan&Gans')
					reply(mess.wait)
            ...
            break
                                ...
                                case 'neonlogo':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}neonlogo RamlanGans')
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://tobz-api.herokuapp.com/api/textpro?theme=neon_light&text=${teks1}&apikey=BotWeA`, {method: 'get'})
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Dah jadi nihh...'})
                                        break
                                case 'neonlogo2':
                                        var gh = body.slice(10)
                                        teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}neonlogo2 RamlanGans')
                                        reply(mess.wait)
                                ...
                                case 'lionlogo':
                                        ...
                                        var teks1 = gh.split("&")[0];
                                        var teks2 = gh.split("&")[1];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}lionlogo Ramlan&Gans')
                                        reply(mess.wait)
                                        ...
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Buset kemren...'})
                                        break
                                /*case 'jsholat':
                                        tels = body.slice(8)
                                ...
                                case 'jokerlogo':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}jokerlogo Ramlan')
                                        reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.daftarB)
			       ...
			       reply(anu.result.jadwalTV)
					break
                                case 'afk':
                                        tels = body.slice(4)
                                        if (args.length < 1) return reply('kakak afk:( ada masalah ya?')
                                        if (!isUser) return reply(mess.only.daftarB)
                                ...
                                case 'shadow':
                                        var gh = body.slice(7)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}shadow RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'burnpaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}burnpaper RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'coffee':
                                        var gh = body.slice(7)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}coffee RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'lovepaper':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}lovepaper RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'woodblock':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}woodblock RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'qowheart':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}qowheart RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'mutgrass':
                                        var gh = body.slice(9)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}mutgrass RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'undergocean':
                                        var gh = body.slice(12)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}undergocean RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'woodenboards':
                                        ...
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}woodenboards RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'wolfmetal':
                                        var gh = body.slice(10)
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}wolfmetal RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case 'metalictglow':
                                        ...
                                        var teks1 = gh.split("&")[0];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}metalictglow RamlanGans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
                                ...
                                case '8bit':
                                        ...
                                        var teks1 = gh.split("&")[0];
                                        var teks2 = gh.split("&")[1];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}8bit Ramlan&Gans')
                                        if (!isUser) return reply(mess.only.daftarB)
                                        reply(mess.wait)
